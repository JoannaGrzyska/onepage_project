...
<!-- NAWIGACJA  -->
		...
		<button  class= "mobile mobile-btn"></button>
<!-- LOGOTYP -->
		<div class="site-branding">
			<?php
			if ( is_front_page() || is_home() ) : ?>
				<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/dist/svg/BOTIGA.svg " alt="">
			</a></h1>
			<?php else : ?>
